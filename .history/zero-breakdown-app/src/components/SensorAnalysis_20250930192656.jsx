    ...
    <div className="sensor-analysis-container">
      ...
      <div className="form-section">
        ...
        <div className="button-group">
          <button onClick={analyzeSensors} disabled={loading}>
            {loading ? '⏳ กำลังวิเคราะห์...' : '🔍 วิเคราะห์ Sensor'}
          </button>
          <button onClick={predictBreakdown} disabled={loading} className="btn-predict">
            {loading ? '⏳ กำลังทำนาย...' : '🔮 ทำนาย Zero Breakdown'}
          </button>
        </div>
      </div>
        ...
        <div className="result-section">
          ...
          {result.alerts.length > 0 ? (
            <div className="alerts-box">
              <h4>⚠️ แจ้งเตือน ({result.alerts.length} รายการ)</h4>
              <ul>
            ...
            <div className="success-box">
              <p>✅ เครื่องจักรทำงานปกติ ไม่พบความผิดปกติ</p>
            </div>
          )}
      ...
      {predictionResult && (
        <div className="result-section prediction-result">
          <h3>🔮 ผลการทำนาย Zero Breakdown</h3>
