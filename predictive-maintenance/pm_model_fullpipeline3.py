# =========================================
# Production-ready Predictive Maintenance pipeline (Class III Sugarcane Mill) - Full Improved Version
# Features:
# - Hybrid labeling (lead-time 6–12 hrs, thresholds Winding/OilGear/Vrms/Current)
# - Rolling/delta/slope/z-score features
# - Semi-supervised K-Means cluster layer
# - Optional FFT features
# - SMOTE-ENN imbalance handling
# - Stacked ensemble: XGB, LGB, RF + LogisticRegression meta
# - IsolationForest anomaly detection
# - Alerts: probability + anomaly + cluster + threshold exceedance
# - Metrics: classification_report, confusion_matrix, ROC-AUC, PR-AUC, lead-time
# - SHAP explainability
...
def hybrid_labeling(df, breakdown_df, label_window_hours=8, thresholds=None):
    ...
    # Label by breakdown logs with extended lead-time
